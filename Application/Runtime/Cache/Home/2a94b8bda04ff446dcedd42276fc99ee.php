<?php if (!defined('THINK_PATH')) exit();?><!DOCTYPE html>
	...
	<head>
		...
		<link rel="stylesheet" href="/Public/liancheng/css/font-awesome.min.css">
		<link rel="stylesheet" href="/Public/liancheng/css/owl.carousel.css">
		<link rel="stylesheet" href="/Public/liancheng/css/owl.transitions.css">
		<link rel="stylesheet" href="/Public/liancheng/css/animate.min.css">
		<link rel="stylesheet" href="/Public/liancheng/css/lightbox.css">
		<link rel="stylesheet" href="/Public/liancheng/css/bootstrap.min.css">
		<link rel="stylesheet" href="/Public/liancheng/css/preloader.css">
		<link rel="stylesheet" href="/Public/liancheng/css/image.css">
		<link rel="stylesheet" href="/Public/liancheng/css/icon.css">
		<link rel="stylesheet" href="/Public/liancheng/css/style.css">
		<link rel="stylesheet" href="/Public/liancheng/css/responsive.css">
...
<script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script>
            ...
            <div class="container">
                <div class="navbar-header">
					...
					<h1 class="navbar-brand">
						<a href="#body"><img src="/Public/liancheng/img/diy_logo1.png" height="40" width="164" alt="">
						</a>
					</h1>
					<!-- /logo -->
                </div>
	...
	<div class="wrapper">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4 col-xs-6">
						<div class="block wow fadeInLeft" data-wow-delay=".3s">
							<img height="370px" src="/Public/liancheng/img/team1.jpg" alt="">
					...
					<div class="col-md-4  col-sm-4 col-xs-6">
						<div class="block wow fadeInLeft" data-wow-delay=".6s">
							<img height="370px" src="/Public/liancheng/img/team2.jpg" alt="">
							<div class="team-overlay">
								<h3>曹灶义<span>董事长</span></h3>
								<span class="icon"><i class="ion-quote"></i></span>
								<p>
					...
					<div class="col-md-4  col-sm-4 col-xs-6">
						<div class="block wow fadeInLeft" data-wow-delay=".9s">
							<img height="370px" src="/Public/liancheng/img/team3.jpg" alt="">
							<div class="team-overlay">
					...
					<div class="col-md-12">
						<div class="block">
							<div id="Client_Logo" class="owl-carousel">
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo1.jpg" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo2.jpg" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo3.jpg" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo4.jpg" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo5.jpg" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo6.jpg" alt=""></a>
								</div>
								<div>
									<a href="#"><img class="img-responsive" src="/Public/liancheng/img/clientLogo/client-logo1.jpg" alt=""></a>
								</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="block">
							...
							<!--<a href="#"><img src="/Public/liancheng/img/diy_logo1.png" alt=""></a>-->
		...
		<!-- load Js -->
		<script src="/Public/liancheng/js/jquery-1.11.3.min.js"></script>
		<script src="/Public/liancheng/js/bootstrap.min.js"></script>
		<script src="/Public/liancheng/js/waypoints.min.js"></script>
		<script src="/Public/liancheng/js/lightbox.js"></script>
		<script src="/Public/liancheng/js/jquery.counterup.min.js"></script>
		<script src="/Public/liancheng/js/owl.carousel.min.js"></script>
		<script src="/Public/liancheng/js/html5lightbox.js"></script>
		<script src="/Public/liancheng/js/jquery.mixitup.js"></script>
		<script src="/Public/liancheng/js/wow.min.js"></script>
		<script src="/Public/liancheng/js/jquery.scrollUp.js"></script>
		<script src="/Public/liancheng/js/jquery.sticky.js"></script>
		<script src="/Public/liancheng/js/jquery.nav.js"></script>
		<script src="/Public/liancheng/js/main.js"></script>
